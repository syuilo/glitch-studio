...
import zoomLines from './effects/zoomLines/_def_.ts';
...
import pixelate from './effects/pixelate/_def_.ts';
import polkadot from './effects/polkadot/_def_.ts';
...
import videoFrame from './effects/videoFrame/_def_.ts';
