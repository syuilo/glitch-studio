...
export default defineEffect({
	...
	paramDefs: {
		...
		density: { dataType: 'number', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Density', default: () => ({ inputSource: 'literal', value: 0.5 }) },
		...
		refraction: { dataType: 'number', ui: { control: 'range', min: 0, max: 2, step: 0.01 }, label: 'Refraction', default: () => ({ inputSource: 'literal', value: 0.6 }) },
