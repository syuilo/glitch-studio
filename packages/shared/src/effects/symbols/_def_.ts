...
export default defineEffect({
	...
	paramDefs: {
		...
		highlightClipThreshold: { dataType: 'number', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Highlight Clip Threshold', default: () => ({ inputSource: 'literal', value: 0.8 }) },
		shadowClipThreshold: { dataType: 'number', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Shadow Clip Threshold', default: () => ({ inputSource: 'literal', value: 0.2 }) },
		divisions: { dataType: 'number', ui: { control: 'range', min: 8, max: 512, step: 1 }, label: 'Cell Divisions', default: () => ({ inputSource: 'literal', value: 64 }) },
		margin: { dataType: 'number', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Cell Margin', default: () => ({ inputSource: 'literal', value: 0.25 }) },
		symbolTexturesRangeMin: { dataType: 'number', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Symbol Textures Range Min', default: () => ({ inputSource: 'literal', value: 0 }) },
		symbolTexturesRangeMax: { dataType: 'number', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Symbol Textures Range Max', default: () => ({ inputSource: 'literal', value: 1 }) },
		...
		similarityThresholdFactor: { dataType: 'number', ui: { control: 'range', min: 0, max: 32, step: 0.1 }, label: 'Similarity Threshold Factor', default: () => ({ inputSource: 'literal', value: 2 }) },
