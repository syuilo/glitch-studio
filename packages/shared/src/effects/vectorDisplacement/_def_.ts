...
export default defineEffect({
	...
	paramDefs: {
		...
		amount: { dataType: 'scalar', ui: { control: 'range', min: -1, max: 1, step: 0.001 }, label: 'Amount', default: () => ({ inputSource: 'literal', value: 0.05 }) },
		...
		rotation: { dataType: 'scalar', ui: { control: 'angle' }, label: 'Rotation', default: () => ({ inputSource: 'literal', value: 0 }) },
