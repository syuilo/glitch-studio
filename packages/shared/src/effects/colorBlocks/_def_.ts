...
export default defineEffect({
	...
	paramDefs: {
		...
		amount: { dataType: 'scalar', ui: { control: 'range', min: 0, max: 100, step: 1 }, label: 'Amount', default: () => ({ inputSource: 'literal', value: 50 }) },
		alphaRandomness: { dataType: 'scalar', ui: { control: 'range', min: 0, max: 1, step: 0.01 }, label: 'Alpha randomness', default: () => ({ inputSource: 'literal', value: 1 }) },
