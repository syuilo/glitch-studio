...
export default defineEffect({
	...
	paramDefs: {
		...
		radius: { type: 'vector', label: 'Radius', min: 0, max: 1, step: 0.01, default: () => ({ inputSource: 'literal', value: [0.7, 0.7] }) },
		quality: { type: 'range', label: 'Quality', min: 0.1, max: 1, step: 0.05, default: () => ({ inputSource: 'literal', value: 0.5 }) },
	},
	outputs: {
