...
export default defineEffect({
	...
	paramDefs: {
		...
		softness: { type: 'range', label: 'Softness', min: 0, max: 1, step: 0.01, default: () => ({ inputSource: 'literal', value: 0.2 }) },
		shiftRed: { type: 'range', label: 'Shift red', min: -1, max: 1, step: 0.01, default: () => ({ inputSource: 'literal', value: 0.3 }) },
		shiftBlue: { type: 'range', label: 'Shift blue', min: -1, max: 1, step: 0.01, default: () => ({ inputSource: 'literal', value: 0.3 }) },
